...
const Hero = () => {
  return (
    <>
        <div className='px-6 mt-20 flex flex-col lg:flex-row lg:justify-between lg:items-center lg:px-30' >
            <div>
           ...
           <div className='mt-10 flex justify-center lg:justify-start'>
             <Link to="/" className='bg-primary p-5 rounded-lg text-white hover:bg-blueish text-bold'>Get Started Now</Link>
           </div>
            </div>
